...
$selecUser=$conn->prepare($sql);
$selecUser->bindParmam(':id',$id);
$selecUser->execute();

$user_data=$selecUser->fetch();
...
<div class="table-responsive">
  ...
  <div class="form-floating">
        ...
        <div class="form-floating">
          ...
          <label for="floatingInput">Movie_name</label>
        </div>
        <div class="form-floating">
          ...
          <label for="floatingInput">movie_desc</label>
        </div>
        <div class="form-floating">
          ...
          <label for="floatingInput">movie_quality</label>
        </div>
